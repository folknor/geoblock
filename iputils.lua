-- https://raw.githubusercontent.com/hamishforbes/lua-resty-iputils/master/lib/resty/iputils.lua
-- MIT license
-- Changed from bit to bit32
...
for i = 0, 32 do
    bin_inverted_masks[tostring(i)] = xor(bin_masks[tostring(i)], bin_masks["32"])
end
...
local function enable_lrucache(size)
    -- Cache the last 4000 IPs (~1MB memory) by default
    local lrucache_obj, err = require("resty.lrucache").new(size or 4000)
